...
static int decode_exec(Decode *s) {
    ...
    INSTPAT("??????? ????? ????? 000 ????? 0011011", addiw  , I, R(rd) = SEXT((uint32_t)((uint32_t)src1 + (uint32_t)imm), 32));//                                              
    ...
    INSTPAT("??????? ????? ????? 110 ????? 0000011", lwu    , I, R(rd) = (word_t)(Mr(src1 + imm, 4)));//
    ...
    INSTPAT("0000000 ????? ????? 000 ????? 0111011", addw   ,RE, R(rd) = SEXT(((uint32_t)src1 + (uint32_t)src2), 32));//
    INSTPAT("0100000 ????? ????? 000 ????? 0110011", sub    ,RE, R(rd) = src1 - src2);//
    INSTPAT("0100000 ????? ????? 000 ????? 0111011", subw   ,RE, R(rd) = SEXT(((uint32_t)src1 - (uint32_t)src2), 32));//
    ...
    INSTPAT("0000001 ????? ????? 000 ????? 0111011", mulw   ,RE, R(rd) = SEXT((uint32_t)((uint32_t)src1 * (uint32_t)src2), 32));
    ...
    INSTPAT("0000001 ????? ????? 010 ????? 0110011", mulhsu ,RE, R(rd) = (word_t)((((int128_t)src1) * ((uint128_t)src2)) >> 64));
