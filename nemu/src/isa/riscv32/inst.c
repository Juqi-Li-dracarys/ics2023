...
#define INSTPAT_MATCH(s, name, type, ... /* execute body */ ) { \
  ...
  INSTPAT("0000000 00001 00000 000 00000 1110011", ebreak , N, NEMUTRAP(s->pc, R(10)));            // 抛出异常，终止 nemu 运行，根据 R10 决定 good or bad
  INSTPAT("0000000 00000 00000 000 00000 1110011", ecall  , N, s->dnpc = EXCEPTION(R(7), s->pc));  // 抛出异常，R7记录事件号，随后跳转
