...
#define INSTPAT_MATCH(s, name, type, ... /* execute body */ ) { \
  ...
  INSTPAT("0000000 00000 00001 000 00000 1100111", ret    , I, R(rd) = s->pc + 4; s->dnpc = (src1 + imm) & (~(word_t)0x01);); 
  INSTPAT("??????? ????? ????? 000 ????? 1100111", jalr   , I, R(rd) = s->pc + 4; s->dnpc = (src1 + imm) & (~(word_t)0x01);); // 跳转并寄存器链接
